...
import com.o2d.pkayjava.runtime.resources.*;
 ...
 */
public class ResourceManagerLoader extends AsynchronousAssetLoader<com.o2d.pkayjava.runtime.resources.ResourceManager, ResourceManagerLoader.AsyncResourceManagerParam> {

    private AsyncResourceManager asyncResourceManager;

    private com.o2d.pkayjava.runtime.data.ProjectInfoVO projectInfoVO;
    ...
    @Override
    public com.o2d.pkayjava.runtime.resources.ResourceManager loadSync(AssetManager manager, String fileName, FileHandle file, AsyncResourceManagerParam parameter) {
    ...
    public static class AsyncResourceManagerParam extends AssetLoaderParameters<com.o2d.pkayjava.runtime.resources.ResourceManager> {
    }

    private static class AsyncResourceManager extends com.o2d.pkayjava.runtime.resources.ResourceManager {
        ...
        public void setProjectInfoVO(com.o2d.pkayjava.runtime.data.ProjectInfoVO vo) {
            this.projectVO = vo;
        }
