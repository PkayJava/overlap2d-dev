 ...
 */
public class ResourceManager implements com.o2d.pkayjava.runtime.resources.IResourceLoader, com.o2d.pkayjava.runtime.resources.IResourceRetriever {
    ...
    protected com.o2d.pkayjava.runtime.data.ProjectInfoVO projectVO;

    protected ArrayList<String> preparedSceneNames = new ArrayList<String>();
    protected HashMap<String, com.o2d.pkayjava.runtime.data.SceneVO> loadedSceneVOs = new HashMap<String, com.o2d.pkayjava.runtime.data.SceneVO>();
    ...
    protected HashSet<com.o2d.pkayjava.runtime.resources.FontSizePair> fontsToLoad = new HashSet<com.o2d.pkayjava.runtime.resources.FontSizePair>();
    ...
    protected HashMap<com.o2d.pkayjava.runtime.resources.FontSizePair, BitmapFont> bitmapFonts = new HashMap<com.o2d.pkayjava.runtime.resources.FontSizePair, BitmapFont>();
    ...
    public void setWorkingResolution(String resolution) {
        com.o2d.pkayjava.runtime.data.ResolutionEntryVO resolutionObject = getProjectVO().getResolution("resolutionName");
    ...
    public void prepareAssetsToLoad() {
        ...
        for (String preparedSceneName : preparedSceneNames) {
            com.o2d.pkayjava.runtime.data.CompositeVO composite = loadedSceneVOs.get(preparedSceneName).composite;
            if (composite == null) {
                continue;
            }
            //
            ...
            com.o2d.pkayjava.runtime.resources.FontSizePair[] fonts = composite.getRecursiveFontList();
            for(com.o2d.pkayjava.runtime.data.CompositeItemVO library : projectVO.libraryItems.values()) {
                com.o2d.pkayjava.runtime.resources.FontSizePair[] libFonts = library.composite.getRecursiveFontList();
    ...
    public void loadFonts() {
    	...
    	com.o2d.pkayjava.runtime.data.ResolutionEntryVO curResolution = getProjectVO().getResolution(packResolutionName);
        resMultiplier = 1;
        ...
        // empty existing ones that are not scheduled to load
        for (com.o2d.pkayjava.runtime.resources.FontSizePair pair : bitmapFonts.keySet()) {
            if (!fontsToLoad.contains(pair)) {
                bitmapFonts.remove(pair);
            }
        }

        for (com.o2d.pkayjava.runtime.resources.FontSizePair pair : fontsToLoad) {
            loadFont(pair);
        }
    }

    public void loadFont(com.o2d.pkayjava.runtime.resources.FontSizePair pair) {
        FileHandle fontFile;
    ...
    public com.o2d.pkayjava.runtime.data.SceneVO loadSceneVO(String sceneName) {
        ...
        Json json = new Json();
        com.o2d.pkayjava.runtime.data.SceneVO sceneVO = json.fromJson(com.o2d.pkayjava.runtime.data.SceneVO.class, file.readString());
    ...
    public com.o2d.pkayjava.runtime.data.ProjectInfoVO loadProjectVO() {
        ...
        Json json = new Json();
        projectVO = json.fromJson(com.o2d.pkayjava.runtime.data.ProjectInfoVO.class, file.readString());
    ...
    public BitmapFont getBitmapFont(String name, int size) {
        return bitmapFonts.get(new com.o2d.pkayjava.runtime.resources.FontSizePair(name, size));
    }
