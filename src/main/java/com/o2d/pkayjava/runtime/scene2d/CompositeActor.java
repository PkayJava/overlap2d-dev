...
import com.o2d.pkayjava.runtime.data.CoreActorData;
...
import com.o2d.pkayjava.runtime.scene2d.*;
import com.o2d.pkayjava.runtime.scene2d.ButtonClickListener;
...
public class CompositeActor extends Group {
    ...
    private com.o2d.pkayjava.runtime.resources.IResourceRetriever ir;

    private float pixelsPerWU;

    protected com.o2d.pkayjava.runtime.data.CompositeItemVO vo;

    private HashMap<Integer, Actor> indexes = new HashMap<Integer, Actor>();
    private HashMap<String, com.o2d.pkayjava.runtime.data.LayerItemVO> layerMap = new HashMap<String, com.o2d.pkayjava.runtime.data.LayerItemVO>();

    public CompositeActor(com.o2d.pkayjava.runtime.data.CompositeItemVO vo, com.o2d.pkayjava.runtime.resources.IResourceRetriever ir) {
        this(vo, ir, BuiltItemHandler.DEFAULT);
    }

    public CompositeActor(com.o2d.pkayjava.runtime.data.CompositeItemVO vo, com.o2d.pkayjava.runtime.resources.IResourceRetriever ir, BuiltItemHandler itemHandler) {
        this(vo, ir, itemHandler, true);
    }

    private CompositeActor(com.o2d.pkayjava.runtime.data.CompositeItemVO vo, com.o2d.pkayjava.runtime.resources.IResourceRetriever ir, BuiltItemHandler itemHandler, boolean isRoot) {
        this.ir= ir;
        this.vo = vo;
    ...
    private void makeLayerMap(com.o2d.pkayjava.runtime.data.CompositeItemVO vo) {
        layerMap.clear();
    ...
    private void build(com.o2d.pkayjava.runtime.data.CompositeItemVO vo, BuiltItemHandler itemHandler, boolean isRoot) {
    ...
    private void buildComposites(ArrayList<com.o2d.pkayjava.runtime.data.CompositeItemVO> composites, BuiltItemHandler itemHandler) {
    ...
    private void buildImages(ArrayList<com.o2d.pkayjava.runtime.data.SimpleImageVO> images, BuiltItemHandler itemHandler) {
    ...
    private void build9PatchImages(ArrayList<com.o2d.pkayjava.runtime.data.Image9patchVO> patches, BuiltItemHandler itemHandler) {
    ...
    private void buildLabels(ArrayList<com.o2d.pkayjava.runtime.data.LabelVO> labels, BuiltItemHandler itemHandler) {
    ...
    private void processMain(Actor actor, com.o2d.pkayjava.runtime.data.MainItemVO vo) {
    ...
    private void buildCoreData(Actor actor, com.o2d.pkayjava.runtime.data.MainItemVO vo){

        //custom variables
        com.o2d.pkayjava.runtime.utils.CustomVariables cv = null;
        if(vo.customVars != null && !vo.customVars.isEmpty()) {
            cv = new com.o2d.pkayjava.runtime.utils.CustomVariables();
            cv.loadFromString(vo.customVars);
        }

        //core data
        com.o2d.pkayjava.runtime.data.CoreActorData data = new com.o2d.pkayjava.runtime.data.CoreActorData();
    ...
    public Actor getItem(String id) {
        for(Actor actor: getChildren()) {
            ...
            if(userObject != null && userObject instanceof com.o2d.pkayjava.runtime.data.CoreActorData
                    && (id.equals(((com.o2d.pkayjava.runtime.data.CoreActorData) userObject).id))) {
                return actor;
            }
        }
        return null;
    ...
    public void setLayerVisibility(String layerName, boolean isVisible) {
        ...
        for(Actor actor: getChildren()) {
            Object userObject = actor.getUserObject();
            if(userObject != null && userObject instanceof com.o2d.pkayjava.runtime.data.CoreActorData
                    && ((com.o2d.pkayjava.runtime.data.CoreActorData)userObject).layerIndex == layerIndex) {
    ...
    public Array<Actor> getItemsByTag(String tag) {
        ...
        for(Actor actor: getChildren()) {
            Object userObject = actor.getUserObject();
            if(userObject != null && userObject instanceof com.o2d.pkayjava.runtime.data.CoreActorData) {
                com.o2d.pkayjava.runtime.data.CoreActorData data = (com.o2d.pkayjava.runtime.data.CoreActorData) userObject;
    ...
    public com.o2d.pkayjava.runtime.data.CompositeItemVO getVo() {
        return vo;
    }
        ...
        BuiltItemHandler DEFAULT = new BuiltItemHandler() {
            ...
            public void onItemBuild(Actor item) {
                ...
                if(item instanceof CompositeActor) {
                    com.o2d.pkayjava.runtime.data.CoreActorData data = (com.o2d.pkayjava.runtime.data.CoreActorData) item.getUserObject();
                    if(data != null && data.tags != null && Arrays.asList(data.tags).contains("button"))
                        item.addListener(new com.o2d.pkayjava.runtime.scene2d.ButtonClickListener());
                }
            }
        };
    }
