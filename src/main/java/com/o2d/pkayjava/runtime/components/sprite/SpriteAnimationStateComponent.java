...
public class SpriteAnimationStateComponent implements Component {
    ...
    public void set(com.o2d.pkayjava.runtime.components.sprite.SpriteAnimationComponent sac) {
        set(sac.frameRangeMap.get(sac.currentAnimation), sac.fps, sac.playMode);
    }

    public void set(com.o2d.pkayjava.runtime.data.FrameRange range, int fps, Animation.PlayMode playMode) {
