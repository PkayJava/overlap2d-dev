...
public class NinePatchDrawableLogic implements com.o2d.pkayjava.runtime.systems.render.logic.Drawable {
    ...
    public void draw(Batch batch, Entity entity) {
        ...
        entityNinePatchComponent.ninePatch.draw(batch, entityTransformComponent.getX(), entityTransformComponent.getY(), entityDimensionsComponent.width, entityDimensionsComponent.height);
    }
