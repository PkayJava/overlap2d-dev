...
import com.o2d.pkayjava.editor.utils.poly.Clipper;
import com.o2d.pkayjava.runtime.utils.ComponentRetriever;
import com.o2d.pkayjava.editor.utils.poly.PolygonUtils;
...
import com.o2d.pkayjava.editor.view.ui.followers.PolygonFollower;
...
public class PolygonTool extends SelectionTool implements PolygonTransformationListener {
    ...
    public void handleNotification(Notification notification) {
        if (AddComponentToItemCommand.DONE.equals(notification.getName())) {
            updateSubFollowerList();
