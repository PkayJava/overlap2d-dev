...
import com.o2d.pkayjava.editor.view.stage.tools.TransformTool;
import com.o2d.pkayjava.editor.view.ui.box.UIToolBoxMediator;
import com.o2d.pkayjava.editor.view.ui.widget.EmptyTarget;
...
public class NormalSelectionFollower extends BasicFollower {
    ...
    private void positionTransformables() {
        ...
        miniRects[ORIGIN].setX((int) (transformComponent.getOriginX() * transformComponent.getScaleX()) - w);
        miniRects[ORIGIN].setY((int) (transformComponent.getOriginY() * transformComponent.getScaleY()) - h);
    ...
    public void handleNotification(Notification notification) {
        ...
        if (UIToolBoxMediator.TOOL_SELECTED.equals(notification.getName())) {
