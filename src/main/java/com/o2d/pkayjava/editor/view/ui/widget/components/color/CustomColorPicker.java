...
public class CustomColorPicker extends VisWindow implements Disposable {
    ...
    private VisTable createColorsPreviewTable() {
        ...
        table.add(currentColor = new AlphaImage(VisUI.getSkin().get(ColorPickerStyle.class))).height(25).expandX().fillX();
        table.row();
        table.add(new VisLabel("New")).spaceRight(3);
        table.add(newColor = new AlphaImage(VisUI.getSkin().get(ColorPickerStyle.class))).height(25).expandX().fillX();
    ...
    private void createColorWidgets() {
        ...
        palette = new Palette(VisUI.getSkin().get(ColorPickerStyle.class), VisUI.getSkin().get(com.kotcrab.vis.ui.Sizes.class), paletteTexture, 0, 0, 100, new ChangeListener() {
            @Override
            public void changed(ChangeEvent event, Actor actor) {
        ...
        verticalBar = new VerticalChannelBar(VisUI.getSkin().get(ColorPickerStyle.class), VisUI.getSkin().get(com.kotcrab.vis.ui.Sizes.class), barTexture, 0, 360, new ChangeListener() {
            @Override
            public void changed(ChangeEvent event, Actor actor) {
