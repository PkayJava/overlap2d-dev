...
package com.o2d.pkayjava.editor.view.ui.widget.components.color;
...
import com.o2d.pkayjava.editor.view.ui.widget.components.color.*;
import com.o2d.pkayjava.editor.view.ui.widget.components.color.ColorInputField;
...
public class ColorChannelWidget extends VisTable implements Disposable {
    ...
    private ChannelBar createBarImage () {
        if (useAlpha)
            return new AlphaChannelBar(com.kotcrab.vis.ui.VisUI.getSkin().get(com.kotcrab.vis.ui.widget.color.ColorPickerStyle.class), com.kotcrab.vis.ui.VisUI.getSkin().get(com.kotcrab.vis.ui.Sizes.class), texture, value, maxValue, barListener);
        else
            return new ChannelBar(com.kotcrab.vis.ui.VisUI.getSkin().get(com.kotcrab.vis.ui.widget.color.ColorPickerStyle.class), com.kotcrab.vis.ui.VisUI.getSkin().get(com.kotcrab.vis.ui.Sizes.class), texture, value, maxValue, barListener);
    }
